 ...
 * 
 */
@WebServiceClient(name = "Server", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/Week09BServer/Server?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Week09BServer/Server?wsdl");
